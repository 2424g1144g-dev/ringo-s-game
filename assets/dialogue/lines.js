...
DIALOGUE_LINES.dialogueStart = [
  ...
  { name: "ヤマモト　ケイゾウ", lines: [{segments: [{text: "じゃあ早速議論を始めましょうか..."}]},
                                        {segments: [{text: "妻も愛犬のパピヨンも待っとるしな..."}], event: [{type: "cameraMove", to: {toX: 18, y: 27, z: -17}, speed: 999, toFov: 45, fovSpeed: 999, speed: 999, yaw: -45, rotSpeed: 999, slide: "X", slideYaw: -45}]}]}
]

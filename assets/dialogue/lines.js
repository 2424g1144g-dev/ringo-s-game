...
DIALOGUE_LINES.dialogueStart = [
  ...
  { name: "ヤマモト　シゲオ", lines: [{segments: [{text: "まずは...事件についてまとめるってのはどうじゃ？"}], event: [{type: "cameraMove", to: {toX: 0, y: 27, z: 10}, toFov: 45, fovSpeed: 999, speed: 999, yaw: 180, pitch: -20, rotSpeed: 999, slide: "zoomOut", slideFov: 55, slideFovSpeed: 0.001, slidePitch: -20},{type: "changeExpression", char: "SHIGE", src: "assets/three/characters/SHIGE/Shige_Doubt.png"}]}]},

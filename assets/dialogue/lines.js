...
DIALOGUE_LINES.dialogueStart = [
  ...
  { name: "フルイチ　ヒデハル", lines: [{segments: [{text: "ちゃっかり自分は容疑者から外すんですねー..."}], event: [{type: "cameraMove", to: {toX: 0, y: 30, z: 0},toFov: 45, fovSpeed: 999, speed: 999, yaw: 35, roll: 30, rotSpeed: 999, slide: "Z", slideYaw: 45, slideRotSpeed: 0.02},{type: "changeExpression", char: "FAKEFURUICHI", src: "assets/three/characters/FAKEFURUICHI/FakeFuruichi_See.png"}]},

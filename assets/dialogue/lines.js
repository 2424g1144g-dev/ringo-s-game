...
DIALOGUE_LINES.dialogueStart = [
  ...
  { name: "シノハラ　リュウジ", lines: [{segments: [{text: "おい...本当にこの中に犯人がおるんよな？"}], event: [{type: "cameraMove", to: {x: -10, y: 23, z: 0},toFov: 45, fovSpeed: 999, speed: 999, yaw: 90, rotSpeed: 999, slide: "left"}]}]},

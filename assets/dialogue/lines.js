...
DIALOGUE_LINES.dialogueStart = [
  ...
  { name: "ヤマモト　ケイゾウ", lines: [{segments: [{text: "じゃあ早速議論を始めましょうか..."}], event: [{type: "cameraMove", to: {toX: 15, y: 23, z: 11}, speed: 999, toFov: 45, fovSpeed: 999, speed: 999, yaw: 225, rotSpeed: 999, slide: "X", slideYaw: 225}]},

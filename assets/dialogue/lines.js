...
DIALOGUE_LINES.dialogueStart = [
  ...
  { name: "シノハラ　リュウジ", lines: [{segments: [{text: "おい...本当にこの中に犯人がおるんよな？"}], event: [{type: "cameraMove", to: {toX: -10, toY: 23, toZ: 0},toFov: 45, fovSpeed: 999, speed: 999, yaw: 80, rotSpeed: 999, slide: "Z", slideYaw: 90, slideRotSpeed: 0.02}]}]},

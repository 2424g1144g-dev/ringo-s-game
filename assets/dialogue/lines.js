...
DIALOGUE_LINES.description = [
  ...
  { name: "ニシモト　タツロウ", lines: [{segments: [{text: " "}],event: [{type: "diaShowToggle"},{type: "fileShowToggle"}], autoNext: true, dialogueAutoNext: true, wait: 2000}]},
  { name: "ニシモト　タツロウ", lines: [{segments: [{text: "現場は体育館..."},{text: "サイコウファイル", class: "yellow"},{text: "によると..."}]}]},
...
DIALOGUE_LINES.dialogueStart = [
  ...
  { name: " ", lines: [{segments: [{text: " "}], event: [{type: "textEnterChange", id: false},{type: "nonstopDebateCamera", id: "DebateBreak", bullets: ["シノハラの証言","密室の体育館"]}]}]}
]
DIALOGUE_LINES.nd1 = [
